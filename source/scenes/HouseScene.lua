HouseScene = {}
class("HouseScene").extends(NobleScene)
local scene = HouseScene
...
-- scene.variable2 = nil
-- "Public" variable.
-- When accessed outside this file, call it using HouseScene.variable2.
...
function scene:drawBackground()
	...
	Noble.Text.draw(Global.GamePlayingField.cashTotal  .. "/30", self.elementsX, self.elementCashY + self.elementsYOffset, Noble.Text.ALIGN_CENTER, false, Noble.Text.FONT_SYSTEM)
